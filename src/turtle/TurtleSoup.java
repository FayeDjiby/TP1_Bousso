...
public class TurtleSoup {
    ...
    public static void drawPersonalArt(Turtle turtle) {
        ...
        for(int i = 0; i < 9; i++){ // i < 15 to limit size of shapes
    ...
    //		Colorier en bleu turtle
        
    //    turtle.color(PenColor.BLUE);
        
  //		Colorier en jaune turtle
        
 //       turtle.color(PenColor.YELLOW);
        
 //			Colorier en rouge turtle
        
     turtle.color(PenColor.RED);
        
//       Dessiner un Heptagone (Polygone)
        
        //drawRegularPolygon(turtle, 9, 60);
        
 //		Dessiner un carre
  //      drawSquare(turtle, 220);
        
//		 Dessiner un Art Personnel
